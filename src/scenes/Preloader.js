...
export class Preloader extends Scene {
  ...
  preload() {
    ...
    // Example Wallet UI Elements (not currently used, but loaded)
    ...
    this.load.spritesheet(
      "Attack_1",
      "assets/sprites/Countess_Vampire/Attack_1.png",
      {
        frameWidth: 128,
        frameHeight: 128,
      }
    ...
    this.load.spritesheet(
      "Blood_Charge",
      "assets/sprites/Countess_Vampire/Blood_Charge_1.png",
      {
        frameWidth: 64,
        frameHeight: 48,
      }
    ...
    for (let i = 1; i <= 4; i++) {
      this.load.spritesheet(
        `Zombie${i}_Attack`,
        `assets/sprites/Zombie_${i}/Attack.png`,
        { frameWidth: 128, frameHeight: 128 }
      );
      this.load.spritesheet(
        `Zombie${i}_Dead`,
        `assets/sprites/Zombie_${i}/Dead.png`,
        { frameWidth: 128, frameHeight: 128 }
      );
      this.load.spritesheet(
        `Zombie${i}_Hurt`,
        `assets/sprites/Zombie_${i}/Hurt.png`,
        { frameWidth: 128, frameHeight: 128 }
      );
      this.load.spritesheet(
        `Zombie${i}_Idle`,
        `assets/sprites/Zombie_${i}/Idle.png`,
        { frameWidth: 128, frameHeight: 128 }
      );
      this.load.spritesheet(
        `Zombie${i}_Walk`,
        `assets/sprites/Zombie_${i}/Walk.png`,
        { frameWidth: 128, frameHeight: 128 }
      );
    }
